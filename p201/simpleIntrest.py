...
def calculate_interest():
    ...
    message=Label(result_frame,text="Interest"+str(p)+" at rate of interest "+str(r)+"% for "+str(t)+" years is."+str(interest), bg = "grey", font=("Calibri", 12), width=55)
...
principle_label=Label(window, text="Principle", fg = "black", bg = "grey", font=("Calibri", 12),bd=1)
...
result=Label(result_frame,text="Your result", bg = "grey", font=("Calibri", 12), width=55)
